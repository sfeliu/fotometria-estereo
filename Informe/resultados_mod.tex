...
Concluimos con que modificar la cantidad de vecindades repercute fuertemente en la realizaci\'on del resto del modelo, ya que con una mala direcci\'on de la luz se perdera el efecto 3D, o mas bien parecera como que se obtuvo el efecto solo de uno de los lados (de derecha a izquierda). \par



\section{N\'umero de condici\'on}
