...
En los algoritmos se trato de aprobechar tanto como fuera posible los patrones o irregularidades que se observaban tanto en la matriz M , como la matriz A(re sultante de $M^{t}$M) y asi poder optimizar el tiempo y la estructura que se usa.
La estructura que se usa, permite que la transposicion de una matriz se realize en O(1).
la variable cols guarda el orden de las columnas, de tal manera que permutar una fila sea en O(1).
